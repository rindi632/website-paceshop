...
//---------------------------- ADMIN ---------------------------
  ...
  elseif ($page == "laporan") include("page/admin/transaksi/laporan.php");
  elseif ($page == "harian") include("page/admin/transaksi/harian.php");
  elseif ($page == "tahunan") include("page/admin/transaksi/tahunan.php");
  elseif ($page == "bulanan") include("page/admin/transaksi/bulanan.php");
  elseif ($page == "laporan_pelanggan") include("page/admin/transaksi/laporan_pelanggan.php");
